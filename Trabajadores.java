...
public class Trabajadores {
	 public static final double VALOR_HORAS_EXTRA = 276.5;
	   ...
	   /* public Trabajadores(int i, String string, String string2, String string3, int j, int k, int l) {
	    }*/
	    
	    public 	Trabajadores(int id, String nombre, String paterno, String materno, double sueldoBase, int horasExtra, int anioIngreso) {
	        this.id = id;
	        this.nombre = nombre;
